--========================================--
-- SF2CE Lua Training Mode for Fightcade2 --
--                 by yacsha              --
--           v0.1 (2020/11/22)            --
--========================================--
...
--
print("Street Fighter 2 Champion Edition - Yacsha Training mode for Fightcade2 v0.1 - based in SSF2X TM by pof")
...
local function pof_training_logic()
	...
	if training_mode == 1 then
		-- disable dizzy
		memory.writeword(game.training_logic.A17,0)
		memory.writeword(game.training_logic.A18,0)
	end
...
local function toggle_background_stage()
	...
	--if game.training_logic.A20~=0xFFDD5E then
